...
class _$_UserMeta implements _UserMeta {
  const _$_UserMeta(
      ...
      @JsonKey(name: 'next_token') required this.nextToken});
  ...
  @override
  String toString() {
    return 'UserMeta(resultCount: $resultCount, nextToken: $nextToken)';
  }
...
abstract class _UserMeta implements UserMeta {
  const factory _UserMeta(
          ...
          @JsonKey(name: 'next_token') required final String nextToken}) =
      _$_UserMeta;
